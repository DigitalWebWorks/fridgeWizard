  ...
  return (
    <div className='flex items-center justify-between'>
      <div className='flex flex-col gap-4 w-[850px] mx-20'>
        ...
        <Link to='/login'>
          <div
            className=" font-mynerve bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 hover:transform hover:transition-all hover:scale-110 cursor-pointer flex text-2xl bg-blue-600 bg-opacity-95 text-white items-center justify-center gap-2 rounded-2xl mt-4 mr-44 p-4 w-[250px] shadow-xl " >
